...
for line in fileinput.input():
    ...
    line = line.replace('SOC EXPLORATION GEOPHYSICISTS','SOCIETY OF EXPLORATION GEOPHYSICISTS')
    line = line.replace('SOC HISPANO-LUSO-AMER LEPIDOPTEROLOGIA-SHILAP','SOCIETY OF HISPANO-LUSO-AMERICAN LEPIDOPTEROLOGIA-SHILAP')
    line = line.replace('JAPANESE SOC DENTAL MATERIALS DEVICES','THE JAPANESE SOCIETY OF DENTAL MATERIALS AND DEVICES')
    line = line.replace('UNIV ESTADUAL MARINGA, PRO-REITORIA PESQUISA POS-GRADUACAO','UNIVERSIDADE ESTADUAL de MARINGA, PRO-REITORIA de PESQUISA POS-GRADUACAO')
    line = line.replace('SOC LAPAROENDOSCOPIC SURGEONS','SOCIETY OF LAPAROENDOSCOPIC SURGEONS, INC')
    line = line.replace('SOC ARGENTINA BOTANICA','SOCIEDAD ARGENTINA de BOTANICA')
    line = line.replace('PENN STATE UNIV PRESS','THE PENN STATE UNIVERSITY PRESS')
    line = line.replace('REVISTA BRASILEIRA ZOOTECNIA BRAZILIAN JOURNAL ANIMAL SCI','REVISTA BRASILEIRA de ZOOTECNIA - BRAZILIAN JOURNAL OF ANIMAL SCIENCE')
    line = line.replace('ARIEL UNIV CALGARY','ARIEL - UNIVERSITY OF CALGARY')
    line = line.replace('ACAD SCIENCES CZECH REPUBLIC, INST MATHEMATICS','ACADEMY OF SCIENCES OF THE CZECH REPUBLIC, INSTITUTE OF MATHEMATICS')
    line = line.replace('ALDRICH CHEMICAL CO INC','ALDRICH CHEMICAL COMPANY INC')
    line = line.replace('STANFORD UNIV, STANFORD LAW SCHOOL','STANFORD UNIVERSITY, STANFORD LAW SCHOOL')
    line = line.replace('SPIE-SOC PHOTO-OPTICAL INSTRUMENTATION ENGINEERS','SPIE-SOCIETY OF PHOTO-OPTICAL INSTRUMENTATION ENGINEERS')
    ...
    line = line.replace('SCIENCE \& TECHNOLOGY NETWORK INC','SCIENCE AND TECHNOLOGY NETWORK INC')
    line = line.replace('WILDLIFE DISEASE ASSOC, INC','WILDLIFE DISEASE ASSOCIATION, INC')
    line = line.replace('AMER SOC ENGINEERING EDUCATION','AMERICAN SOCIETY FOR ENGINEERING EDUCATION')
    line = line.replace('ASSOC FIRE ECOLOGY','ASSOCIATION FOR FIRE ECOLOGY')
    line = line.replace('COUNCIL LEARNING DISABILITIES','COUNCIL FOR LEARNING DISABILITIES')
    line = line.replace('HISTORICAL SOC PA','HISTORICAL SOCIETY OF PENNSYLVANIA')
    line = line.replace('ACOUSTICAL SOC AMER AMERICAN INSTITUTE OF PHYSICS','ACOUSTICAL SOCIETY OF AMERICA')
    line = line.replace('AMER ACAD PSYCHIATRY and LAW','AMERICAN ACADEMY OF PSYCHIATRY AND LAW')
    line = line.replace('AMER INST AERONAUTICS  ASTRONAUTICS','THE AMERICAN INSTITUTE OF AERONAUTICS AND ASTRONAUTICS')
    line = line.replace('AMERICAN INSTITUTE OF BIOLOGICAL SCIENCE','AMERICAN INSTITUTE OF BIOLOGICAL SCIENCES')
    line = line.replace('ASSOC NAC HISTORIA-ANPUH','ASSOCIATION NATIONAL DE HISTORIA-ANPUH')
    line = line.replace('FRESHWATER BIOLOGICAL ASSOC','FRESHWATER BIOLOGICAL ASSOCIATION')
    line = line.replace('PIONEER BIOSCIENCE PUBL CO','PIONEER BIOSCIENCE PUBLISHING COMPANY')
    line = line.replace('UNIV ILLINOIS, URBANA-CHAMPAIGN','UNIVERSITY OF ILLINOIS, URBANA-CHAMPAIGN')
    line = line.replace('MUSEUM \& INST ZOOLOGY PAS-POLISH ACAD SCIENCES','MUSEUM AND INSTITUTE OF ZOOLOGY OF THE POLISH ACADEMY OF SCIENCES')
    line = line.replace('BRITISH CATTLE VETERINARY ASSOC','BRITISH CATTLE VETERINARY ASSOCIATION')
    line = line.replace('AMER  ASSOC TEACHERS SPANISH PORTUGUESE, INC','AMERICAN ASSOCIATION OF TEACHERS OF SPANISH AND PORTUGUESE, INC')
    line = line.replace('AMER ASSOC TEACHERS SLAVIC EAST EUROPEAN LANGUAGES','AMERICAN ASSOCIATION OF TEACHERS OF SLAVIC AND EAST EUROPEAN LANGUAGES')
    line = line.replace('AMER ASSOC COLL PHARMACY','AMERICAN ASSOCIATION OF COLLEGES OF PHARMACY')
    line = line.replace('DENVER UNIV LAW REV','DENVER UNIVERSITY LAW REVIEW')
    line = line.replace('GEOLOGICAL SOC PUBL HOUSE','GEOLOGICAL SOCIETY PUBLISHERS HOUSE')
    line = line.replace('HUNTER COLLEGE-CUNY, CENTER PUERTO RICAN STUDIES','HUNTER COLLEGE-CUNY, CENTER FOR PUERTO RICAN STUDIES')
    line = line.replace('SAN DIEGO STATE UNIV','SAN DIEGO STATE UNIVERSITY')
    line = line.replace('INST BIOLOGIA, UNIV NACIONAL AUTONOMA MEXICO','INSTITUTE DE BIOLOGIA, UNIVERSITY NACIONAL AUTONOMA MEXICO')
    line = line.replace('SOC ADVANCEMENT BEHAVIOR ANALYSIS','SOCIETY FOR THE ADVANCEMENT OF BEHAVIOR ANALYSIS')
    line = line.replace('ASSOC SCHOOLS PUBLIC HEALTH','ASSOCIATION OF SCHOOLS OF PUBLIC HEALTH')
    line = line.replace('UNIV FEDERAL UBERLANDIA','UNIVERSITY OF FEDERAL UBERLANDIA')
