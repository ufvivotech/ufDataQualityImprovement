...
for line in fileinput.input():
    ...
    #line = line.replace('<NAME FROM BIBTEX FILE IN CAPS>','CORRECT NAME FROM GOOGLE')
    
    line = line.replace('TOHOKU UNIV MEDICAL PRESS','TOHOKU UNIVERSITY MEDICAL PRESS')
    line = line.replace('ADIS INT LTD','ADIS INTERNATIONAL LIMITED')
    line = line.replace('SPIE-SOC PHOTO-OPTICAL INSTRUMENTATION ENGINEERS','THE SOCIETY OF PHOTO-OPTICAL INSTRUMENTATION ENGINEERS')
    line = line.replace('SOC QUIMICA MEXICO','JOURNAL OF THE MEXICAN CHEMICAL SOCIETY')
    line = line.replace('ADIS INT LTD','ADIS INTERNATIONAL LIMITED')
